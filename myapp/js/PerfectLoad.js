...
jQuery.MyCommon = {
    PageLoading: function (options) {
        ...
        var _LoadingHtml = '<div id="loadingPage" style="position:fixed;left:0;top:0;_position: absolute;width:100%;height:' + _PageHeight + 'px;background:' + options.backgroundColor + ';opacity:' + options.opacity + ';filter:alpha(opacity=' + options.opacity * 100 + ');z-index:' + options.zindex + ';"><div id="loadingTips"><div id="loadinglogoText"></div><div id="loadingFace"></div><div id="loadingText">' + options.loadingTips + '</div></div></div>';
