...
//        i++;
//        if(i>$('#inner img').length){
//            i=0;
//        }
//        $('#inner img').eq(i).fadeIn().siblings().hide();
//    },1000)
//
//})
...
//*........................celan jq.....................................*/
$('#celan2 li,#celanx li').mouseover(function(){
    var i=$(this).index();
    $(this).css({'backgroundColor':'#CE0027'});
    $(this).find('div').stop().animate({
       'right':'30px'
    })
})
$('#celan2 li,#celanx li').mouseout(function(){
    var i=$(this).index();
...
/*..............................louceng................................*/
var cLeft=document.getElementById('cleft');
var oSpan=cLeft.getElementsByTagName('span');
window.onscroll=function(e){
    var e=e||window.event;
    cLeft.style.display='none';
    var oTop=document.documentElement.scrollTop||document.body.scrollTop;
    if(oTop>=1200&&oTop<=9200){
        cLeft.style.display='block';
        if(oTop>=1200&&oTop<1900){
            oSpan[1].style.display='none';
            oSpan[0].style.display='block';
            oSpan[0].style.backgroundColor='#C81623';
        ...
        if(oTop>=1900&&oTop<2600){
            oSpan[3].style.display='none';
            oSpan[2].style.display='block';
            oSpan[2].style.backgroundColor='#C81623';
            oSpan[2].style.color='#fff';
        }
        else{
        ...
        if(oTop>=2600&&oTop<3300){
            oSpan[5].style.display='none';
            oSpan[4].style.display='block';
            oSpan[4].style.backgroundColor='#C81623';
            oSpan[4].style.color='#fff';
        }
        else{
            oSpan[5].style.display='block';
            oSpan[4].style.display='none';
            oSpan[4].style.backgroundColor='';
            oSpan[4].style.color='';
        }
        if(oTop>=3300&&oTop<3900){
            oSpan[7].style.display='none';
            oSpan[6].style.display='block';
            oSpan[6].style.backgroundColor='#C81623';
            oSpan[6].style.color='#fff';
        }
        else{
            oSpan[7].style.display='block';
            oSpan[6].style.display='none';
            oSpan[6].style.backgroundColor='';
            oSpan[6].style.color='';
        }
        if(oTop>=3900&&oTop<4600){
            oSpan[9].style.display='none';
            oSpan[8].style.display='block';
            oSpan[8].style.backgroundColor='#C81623';
            oSpan[8].style.color='#fff';
        }
        else{
            oSpan[9].style.display='block';
            oSpan[8].style.display='none';
            oSpan[8].style.backgroundColor='';
            oSpan[8].style.color='';
        }
        if(oTop>=4600&&oTop<5200){
            oSpan[11].style.display='none';
            oSpan[10].style.display='block';
            oSpan[10].style.backgroundColor='#C81623';
            oSpan[10].style.color='#fff';
        }
        else{
            oSpan[11].style.display='block';
            oSpan[10].style.display='none';
            oSpan[10].style.backgroundColor='';
            oSpan[10].style.color='';
        }

        if(oTop>=5200&&oTop<5830){
            oSpan[13].style.display='none';
            oSpan[12].style.display='block';
            oSpan[12].style.backgroundColor='#C81623';
            oSpan[12].style.color='#fff';
        }
        else{
            oSpan[13].style.display='block';
            oSpan[12].style.display='none';
            oSpan[12].style.backgroundColor='';
            oSpan[12].style.color='';
        }
        if(oTop>=5830&&oTop<6450){
            oSpan[14].style.display='none';
            oSpan[15].style.display='block';
            oSpan[15].style.backgroundColor='#C81623';
            oSpan[15].style.color='#fff';
        }
        else{
            oSpan[14].style.display='block';
            oSpan[15].style.display='none';
            oSpan[15].style.backgroundColor='';
            oSpan[15].style.color='';
        }
        if(oTop>=6450&&oTop<7140){
            oSpan[17].style.display='none';
            oSpan[16].style.display='block';
            oSpan[16].style.backgroundColor='#C81623';
            oSpan[16].style.color='#fff';
        }
        else{
            oSpan[17].style.display='block';
            oSpan[16].style.display='none';
            oSpan[16].style.backgroundColor='';
            oSpan[16].style.color='';
        }
        if(oTop>=7140&&oTop<7790){
            oSpan[19].style.display='none';
            oSpan[18].style.display='block';
            oSpan[18].style.backgroundColor='#C81623';
            oSpan[18].style.color='#fff';
        }
        else{
            oSpan[19].style.display='block';
            oSpan[18].style.display='none';
            oSpan[18].style.backgroundColor='';
            oSpan[18].style.color='';
        }
        if(oTop>=7790&&oTop<9000){
            oSpan[21].style.display='none';
            oSpan[20].style.display='block';
            oSpan[20].style.backgroundColor='#C81623';
            oSpan[20].style.color='#fff';
        }
        else{
            oSpan[21].style.display='block';
            oSpan[20].style.display='none';
            oSpan[20].style.backgroundColor='';
            oSpan[20].style.color='';
        }
    }
    else{
        cLeft.style.display='none';
